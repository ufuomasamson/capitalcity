### **We are building an ATTORNEY website here are the website content and images**
...
##### **Nav bar: (Logo, and logo images 'cca-logo.jpg'), (About), (Contact)**
...
Let the above text be over the hero image with a little overlay black color
...
The 'cca.jpg' image on the left column



And on the right column this content



Header text: Meet **Capital City Advocates**



Paragraph Text with Bold: I’ve been offering peace of mind to Arizona families since 1985.



Then plain Paragraph text: I graduated from ASU’s Sandra Day O’Connor law school in Tempe Arizona in 1985  and have practiced in the East Valley - Mesa, Apache Junction, Queen Creek, Gilbert and now Scottsdale - ever since. I also have an office on the West side, in Surprise. I spent decades in courtrooms, helping people with financial difficulties, and in 2010 began my transition into estate planning. Now, I help my clients stay out of legal trouble and give their loved ones a precious gift: An estate plan that will keep their affairs out of court.
...
First centered tittle on top the column: Estate Planning Services





Now the columns has three images with text below them



**Column One image: estate1.jpg**



And the text below it: Header Text: The Basics: Will, Powers of Attorney, Living Will



Paragraph Text: Most people need at least a simple will to clear up any potential disputes and let everyone know how they want their property to be distributed. But to avoid probate, additional steps are needed, such as Beneficiary designations on real estate and financial accounts..
...
**Column Two image: estate2.jpg**



And the text below it: Header: The Living Trust



Paragraph Text: If you have a home, children or a business, you likely also need a Trust.
...
**Column Three image: estate3.jpg**



And the text below: Header: Business Services



Paragraph text: Many estate plans include businesses. If you own a business, you will want to integrate that business into your estate plan .
...
And make sure you don't display the full Paragraph text on each Columns just display little and hide the rest on a 'Read More' button

That when clicked it should then display the full text in Modal
...
A Centered Tittle on top of the column:
...
FAQ Text that reveal answer when clicked on:
...
Answer: It depends. If you have one heir and everything goes to that person, you may not need a Trust. But you will need a Will, and if you have a home, you will need deed work done because a Will alone does not keep your family out of court..





**Is it too late to make a plan?**

Answer: If you are still breathing and know what day it is, it's not too late. We can get a complete plan in place in less than two weeks.
...
Answer: The Will and the Trust can do the same thing: describe how you want your property to be handled when you pass away. They both require additional steps to implement, such as deed work or beneficiary designations on accounts.
...
Answer: Take a test drive at no risk or expense. My first meeting with you is free of charge, and I can do it in person, by phone or as a video chat. There is no obligation. I will quote you a flat fee, with options, and I will stand by it. You don't get that very often from an attorney with decades of experience!
...
Paragraph: 4110 N. Scottsdale Road, Suite 170A

Scottsdale, AZ 85251



2700 S. Gilbert Road, Suite 5
